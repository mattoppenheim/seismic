...
REVEAL_EDITS_SUFFIX = '_Hard_edits.csv'
ENI_EDITS_SUFFIX = '_BADTR_HARD_EDIT'
ENI_OUTPUT_DIR = r'/nfs/D01/Reveal_Projects/7021_Eni_Hewett_Stmr/tables/edits/eni_hard_edits'
