...
REVEAL_EDITS_SUFFIX = '-Source-Depth-Edits-9999.csv'
ENI_EDITS_SUFFIX = '_BADTR_SOURCE_DEPTH_EDIT'
ENI_OUTPUT_DIR = r'/nfs/D01/Reveal_Projects/7021_Eni_Hewett_Stmr/tables/edits/eni_source_depth_edits'
